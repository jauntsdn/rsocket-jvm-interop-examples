...
public final class RecipesClient implements Recipes {
  ...
  public void marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata, io.grpc.stub.StreamObserver<trisocket.Recipe> observer) {
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, decode(trisocket.Recipe.parser()), instrumentationListener));
  }
