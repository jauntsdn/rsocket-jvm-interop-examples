...
public final class RecipesClient implements Recipes {
  ...
  public io.reactivex.rxjava3.core.Single<trisocket.Recipe> marinade(trisocket.Meat message, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.reactivex.rxjava3.core.Single<trisocket.Recipe> marinade = io.reactivex.rxjava3.core.Single.defer(new io.reactivex.rxjava3.functions.Supplier<io.reactivex.rxjava3.core.Single<com.jauntsdn.rsocket.Message>>() {
      ...
      public io.reactivex.rxjava3.core.Single<com.jauntsdn.rsocket.Message> get() {
        ...
        com.jauntsdn.rsocket.generated_72325.ProtobufCodec.encode("RecipesClient", content, message);
    ...
    }).map(com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decode("RecipesClient", trisocket.Recipe.parser()));
