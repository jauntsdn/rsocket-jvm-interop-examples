...
public final class FarmerServer implements com.jauntsdn.rsocket.RpcService {
  ...
  private FarmerServer(Farmer service, com.jauntsdn.rsocket.RpcInstrumentation instrumentation, io.netty.buffer.ByteBufAllocator allocator, com.jauntsdn.rsocket.Rpc.Codec rpcCodec) {
    this.messageEncoder = com.jauntsdn.rsocket.generated_72325.ProtobufCodec.encode("FarmerServer", allocator, rpcCodec);
  ...
  public io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> requestStream(com.jauntsdn.rsocket.Message message) {
    try {
      ...
      io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> handler = requestStreamHandler(flags, method, message.data(), metadata);
      if (handler != null) {
        return handler;
      }
  ...
  public io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> requestChannel(com.jauntsdn.rsocket.Message message, org.reactivestreams.Publisher<com.jauntsdn.rsocket.Message> publisher) {
    try {
      ...
      message.release();
      return io.reactivex.rxjava3.core.Flowable.error(new com.jauntsdn.rsocket.exceptions.RpcException("FarmerServer: requestChannel unknown method: " + method));
    } catch (Throwable t) {
  ...
  private io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> requestStreamHandler(int flags, String method, io.netty.buffer.ByteBuf data, io.netty.buffer.ByteBuf metadata) throws java.io.IOException {
    switch (method) {
      case Farmer.METHOD_MEAT: {
        ...
        com.jauntsdn.rsocket.Headers meatHeaders = com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decodeHeaders(metadata);
        io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> meat = service.meat(trisocket.Order.parseFrom(is), meatHeaders).map(messageEncoder);
      ...
      case Farmer.METHOD_VEGGIES: {
        ...
        com.google.protobuf.CodedInputStream is = com.google.protobuf.CodedInputStream.newInstance(data.internalNioBuffer(0, data.readableBytes()));
        com.jauntsdn.rsocket.Headers veggiesHeaders = com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decodeHeaders(metadata);
        io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> veggies = service.veggies(trisocket.Order.parseFrom(is), veggiesHeaders).map(messageEncoder);
