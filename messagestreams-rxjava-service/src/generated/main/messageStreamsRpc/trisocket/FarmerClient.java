...
public final class FarmerClient implements Farmer {
  ...
  public io.reactivex.rxjava3.core.Flowable<trisocket.Meat> meat(trisocket.Order message, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.reactivex.rxjava3.core.Flowable<trisocket.Meat> meat = io.reactivex.rxjava3.core.Flowable.defer(new io.reactivex.rxjava3.functions.Supplier<io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message>>() {
      ...
      public io.reactivex.rxjava3.core.Flowable<com.jauntsdn.rsocket.Message> get() {
        ...
        com.jauntsdn.rsocket.generated_72325.ProtobufCodec.encode("FarmerClient", content, message);
    ...
    }).map(com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decode("FarmerClient", trisocket.Meat.parser()));
  ...
  public io.reactivex.rxjava3.core.Flowable<trisocket.Veggie> veggies(trisocket.Order message, com.jauntsdn.rsocket.Headers headersMetadata) {
    ...
    }).map(com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decode("FarmerClient", trisocket.Veggie.parser()));
