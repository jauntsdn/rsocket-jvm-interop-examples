...
public final class KitchenServer implements com.jauntsdn.rsocket.RpcService {
  ...
  private KitchenServer(Kitchen service, com.jauntsdn.rsocket.RpcInstrumentation instrumentation, io.netty.buffer.ByteBufAllocator allocator, com.jauntsdn.rsocket.Rpc.Codec rpcCodec) {
    this.messageEncoder = com.jauntsdn.rsocket.generated_72325.ProtobufCodec.encode("KitchenServer", allocator, rpcCodec);
      ...
      switch (method) {
        case Kitchen.METHOD_SERVE: {
          ...
          io.reactivex.rxjava3.core.Flowable<trisocket.Order> messages =
            io.reactivex.rxjava3.core.Flowable.fromPublisher(publisher).map(com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decode("", trisocket.Order.parser()));
          com.jauntsdn.rsocket.Headers serveHeaders = com.jauntsdn.rsocket.generated_72325.ProtobufCodec.decodeHeaders(metadata);
