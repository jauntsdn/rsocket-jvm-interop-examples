...
public final class FarmerClient implements Farmer {
  ...
  public io.smallrye.mutiny.Multi<trisocket.Meat> meat(trisocket.Order message, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.smallrye.mutiny.Multi<trisocket.Meat> meat = io.smallrye.mutiny.Multi.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Multi<? extends com.jauntsdn.rsocket.Message>>() {
      ...
      public io.smallrye.mutiny.Multi<com.jauntsdn.rsocket.Message> get() {
        ...
        com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encode("FarmerClient", content, message);
    ...
    }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("FarmerClient", trisocket.Meat.parser()));
  ...
  public io.smallrye.mutiny.Multi<trisocket.Veggie> veggies(trisocket.Order message, com.jauntsdn.rsocket.Headers headersMetadata) {
    ...
    }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("FarmerClient", trisocket.Veggie.parser()));
