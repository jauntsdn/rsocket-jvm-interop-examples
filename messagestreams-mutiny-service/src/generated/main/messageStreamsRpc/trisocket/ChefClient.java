...
public final class ChefClient implements Chef {
  ...
  public io.smallrye.mutiny.Uni<trisocket.Dish> roast(trisocket.Pan message, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.smallrye.mutiny.Uni<trisocket.Dish> roast = io.smallrye.mutiny.Uni.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Uni<? extends com.jauntsdn.rsocket.Message>>() {
      ...
      public io.smallrye.mutiny.Uni<com.jauntsdn.rsocket.Message> get() {
        ...
        com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encode("ChefClient", content, message);
    ...
    }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("ChefClient", trisocket.Dish.parser()));
