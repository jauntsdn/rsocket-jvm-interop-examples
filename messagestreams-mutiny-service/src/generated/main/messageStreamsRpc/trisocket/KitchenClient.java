...
public final class KitchenClient implements Kitchen {
  ...
  public io.smallrye.mutiny.Multi<trisocket.Dish> serve(java.util.concurrent.Flow.Publisher<trisocket.Order> messages, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.smallrye.mutiny.Multi<trisocket.Dish> serve = 
      io.smallrye.mutiny.Multi.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Multi<? extends com.jauntsdn.rsocket.Message>>() {
        ...
        public io.smallrye.mutiny.Multi<com.jauntsdn.rsocket.Message> get() {
            ...
            new java.util.function.Function<com.google.protobuf.MessageLite, com.jauntsdn.rsocket.Message>() {
              ...
              public com.jauntsdn.rsocket.Message apply(com.google.protobuf.MessageLite message) {
                ...
                if (!started) {
                  ...
                  com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encode("KitchenClient", content, message);
          ...
          }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("KitchenClient", trisocket.Dish.parser()));
