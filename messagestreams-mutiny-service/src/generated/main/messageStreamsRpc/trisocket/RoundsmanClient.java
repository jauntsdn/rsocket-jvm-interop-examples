...
public final class RoundsmanClient implements Roundsman {
  ...
  public io.smallrye.mutiny.Uni<trisocket.Veggie> chop(trisocket.Veggie message, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.smallrye.mutiny.Uni<trisocket.Veggie> chop = io.smallrye.mutiny.Uni.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Uni<? extends com.jauntsdn.rsocket.Message>>() {
      ...
      public io.smallrye.mutiny.Uni<com.jauntsdn.rsocket.Message> get() {
        ...
        io.netty.buffer.ByteBuf metadata = com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encodeHeaders(headersMetadata);
        ...
        com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encode("RoundsmanClient", content, message);
    ...
    }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("RoundsmanClient", trisocket.Veggie.parser()));
  ...
  public io.smallrye.mutiny.Uni<trisocket.Meat> marinade(trisocket.Meat message, com.jauntsdn.rsocket.Headers headersMetadata) {
    ...
    }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("RoundsmanClient", trisocket.Meat.parser()));
