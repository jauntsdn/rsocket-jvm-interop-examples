...
public final class FarmerServer implements com.jauntsdn.rsocket.RpcService {
  ...
  private FarmerServer(Farmer service, com.jauntsdn.rsocket.RpcInstrumentation instrumentation, io.netty.buffer.ByteBufAllocator allocator, com.jauntsdn.rsocket.Rpc.Codec rpcCodec) {
    this.messageEncoder = com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encode("FarmerServer", allocator, rpcCodec);
  ...
  private io.smallrye.mutiny.Multi<com.jauntsdn.rsocket.Message> requestStreamHandler(int flags, String method, io.netty.buffer.ByteBuf data, io.netty.buffer.ByteBuf metadata) throws java.io.IOException {
    switch (method) {
      case Farmer.METHOD_MEAT: {
        ...
        com.jauntsdn.rsocket.Headers meatHeaders = com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decodeHeaders(metadata);
      ...
      case Farmer.METHOD_VEGGIES: {
        ...
        com.google.protobuf.CodedInputStream is = com.google.protobuf.CodedInputStream.newInstance(data.internalNioBuffer(0, data.readableBytes()));
        com.jauntsdn.rsocket.Headers veggiesHeaders = com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decodeHeaders(metadata);
