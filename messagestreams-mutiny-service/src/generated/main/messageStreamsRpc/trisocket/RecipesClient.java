...
public final class RecipesClient implements Recipes {
  ...
  public io.smallrye.mutiny.Uni<trisocket.Recipe> marinade(trisocket.Meat message, com.jauntsdn.rsocket.Headers headersMetadata) {
    io.smallrye.mutiny.Uni<trisocket.Recipe> marinade = io.smallrye.mutiny.Uni.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Uni<? extends com.jauntsdn.rsocket.Message>>() {
      ...
      public io.smallrye.mutiny.Uni<com.jauntsdn.rsocket.Message> get() {
        ...
        com.jauntsdn.rsocket.generated_52358.ProtobufCodec.encode("RecipesClient", content, message);
    ...
    }).map(com.jauntsdn.rsocket.generated_52358.ProtobufCodec.decode("RecipesClient", trisocket.Recipe.parser()));
