...
public final class RoundsmanClient implements Roundsman {
  ...
  public java.util.concurrent.CompletionStage<trisocket.Veggie> chop(trisocket.Veggie message, io.netty.buffer.ByteBuf metadata) {
    ...
    com.jauntsdn.rsocket.generated_51446.ProtobufCodec.encode("RoundsmanClient", content, message);
    ...
    java.util.concurrent.CompletionStage<trisocket.Veggie> chopResponse = messageResponse
      .thenApply(com.jauntsdn.rsocket.generated_51446.ProtobufCodec.decode("RoundsmanClient", trisocket.Veggie.parser()));
  ...
  public java.util.concurrent.CompletionStage<trisocket.Meat> marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata) {
    ...
    java.util.concurrent.CompletionStage<trisocket.Meat> marinadeResponse = messageResponse
      .thenApply(com.jauntsdn.rsocket.generated_51446.ProtobufCodec.decode("RoundsmanClient", trisocket.Meat.parser()));
    if (instrumentationListener != null) {
