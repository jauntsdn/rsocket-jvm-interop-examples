...
public final class ChefClient implements Chef {
  ...
  public java.util.concurrent.CompletionStage<trisocket.Dish> roast(trisocket.Pan message, io.netty.buffer.ByteBuf metadata) {
    ...
    com.jauntsdn.rsocket.generated_51446.ProtobufCodec.encode("ChefClient", content, message);
    ...
    java.util.concurrent.CompletionStage<trisocket.Dish> roastResponse = messageResponse
      .thenApply(com.jauntsdn.rsocket.generated_51446.ProtobufCodec.decode("ChefClient", trisocket.Dish.parser()));
