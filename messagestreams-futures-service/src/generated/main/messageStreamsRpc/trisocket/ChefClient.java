...
public final class ChefClient implements Chef {
  ...
  public java.util.concurrent.CompletionStage<trisocket.Dish> roast(trisocket.Pan message, com.jauntsdn.rsocket.Headers headersMetadata) {
    ...
    io.netty.buffer.ByteBuf metadata = com.jauntsdn.rsocket.generated_45314.ProtobufCodec.encodeHeaders(headersMetadata);
    ...
    com.jauntsdn.rsocket.generated_45314.ProtobufCodec.encode("ChefClient", content, message);
    ...
    java.util.concurrent.CompletionStage<trisocket.Dish> roastResponse = messageResponse
      .thenApply(com.jauntsdn.rsocket.generated_45314.ProtobufCodec.decode("ChefClient", trisocket.Dish.parser()));
