  ...
  private java.util.concurrent.CompletionStage<com.jauntsdn.rsocket.Message> requestResponseHandler(int flags, String method, io.netty.buffer.ByteBuf data, io.netty.buffer.ByteBuf metadata) throws java.io.IOException {
    switch (method) {
      case Roundsman.METHOD_CHOP: {
        ...
        java.util.concurrent.CompletionStage<trisocket.Veggie> chopResponse = service.chop(trisocket.Veggie.parseFrom(is), chopHeaders);
        java.util.concurrent.CompletionStage<com.jauntsdn.rsocket.Message> chopMessageResponse = chopResponse.thenApply(messageEncoder);
        if (instrumentationListener != null) {
          chopMessageResponse.whenComplete(com.jauntsdn.rsocket.RpcService.ResponseListener.create(chopResponse, instrumentationListener.onComplete()));
          return chopMessageResponse;
        }
        chopMessageResponse.whenComplete(com.jauntsdn.rsocket.RpcService.ResponseListener.create(chopResponse));
        return chopMessageResponse;
      }
      case Roundsman.METHOD_MARINADE: {
        ...
        java.util.concurrent.CompletionStage<trisocket.Meat> marinadeResponse = service.marinade(trisocket.Meat.parseFrom(is), marinadeHeaders);
