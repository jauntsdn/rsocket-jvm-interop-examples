...
public final class RecipesClient implements Recipes {
  ...
  public java.util.concurrent.CompletionStage<trisocket.Recipe> marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata) {
    ...
    com.jauntsdn.rsocket.generated_51446.ProtobufCodec.encode("RecipesClient", content, message);
    ...
    java.util.concurrent.CompletionStage<trisocket.Recipe> marinadeResponse = messageResponse
      .thenApply(com.jauntsdn.rsocket.generated_51446.ProtobufCodec.decode("RecipesClient", trisocket.Recipe.parser()));
