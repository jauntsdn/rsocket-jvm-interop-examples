  ...
  private java.util.concurrent.CompletionStage<com.jauntsdn.rsocket.Message> requestResponseHandler(int flags, String method, io.netty.buffer.ByteBuf data, io.netty.buffer.ByteBuf metadata) throws java.io.IOException {
    switch (method) {
      case Chef.METHOD_ROAST: {
        ...
        java.util.concurrent.CompletionStage<trisocket.Dish> roastResponse = service.roast(trisocket.Pan.parseFrom(is), roastHeaders);
        java.util.concurrent.CompletionStage<com.jauntsdn.rsocket.Message> roastMessageResponse = roastResponse.thenApply(messageEncoder);
        if (instrumentationListener != null) {
          roastMessageResponse.whenComplete(com.jauntsdn.rsocket.RpcService.ResponseListener.create(roastResponse, instrumentationListener.onComplete()));
          return roastMessageResponse;
        }
        roastMessageResponse.whenComplete(com.jauntsdn.rsocket.RpcService.ResponseListener.create(roastResponse));
        return roastMessageResponse;
      }
      default: {
        return null;
