...
public final class RoundsmanClient implements Roundsman {
  ...
  private final java.util.function.Function<? super io.helidon.common.reactive.Single<trisocket.Veggie>, ? extends io.helidon.common.reactive.Single<trisocket.Veggie>> chopInstrumentation;
  private final java.util.function.Function<? super io.helidon.common.reactive.Single<trisocket.Meat>, ? extends io.helidon.common.reactive.Single<trisocket.Meat>> marinadeInstrumentation;
  ...
  public io.helidon.common.reactive.Single<trisocket.Veggie> chop(trisocket.Veggie message, io.netty.buffer.ByteBuf metadata) {
    io.helidon.common.reactive.Single<trisocket.Veggie> chop = io.helidon.common.reactive.Single.defer(new java.util.function.Supplier<io.helidon.common.reactive.Single<com.jauntsdn.rsocket.Message>>() {
      @Override
  ...
  public io.helidon.common.reactive.Single<trisocket.Meat> marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata) {
    io.helidon.common.reactive.Single<trisocket.Meat> marinade = io.helidon.common.reactive.Single.defer(new java.util.function.Supplier<io.helidon.common.reactive.Single<com.jauntsdn.rsocket.Message>>() {
      @Override
      public io.helidon.common.reactive.Single<com.jauntsdn.rsocket.Message> get() {
        int externalMetadataSize = streams.attributes().intAttr(com.jauntsdn.rsocket.Attributes.EXTERNAL_METADATA_SIZE);
        int dataSize = message.getSerializedSize();
