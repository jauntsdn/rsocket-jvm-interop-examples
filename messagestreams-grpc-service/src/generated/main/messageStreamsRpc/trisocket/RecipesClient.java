...
public final class RecipesClient implements Recipes {
  ...
  public void marinade(trisocket.Meat message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<trisocket.Recipe> observer) {
    ...
    com.jauntsdn.rsocket.generated_23183.ProtobufCodec.encode("RecipesClient", content, message);
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("RecipesClient", trisocket.Recipe.parser()), instrumentationListener));
  }
}
