...
public final class FarmerClient implements Farmer {
  ...
  public void meat(trisocket.Order message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<trisocket.Meat> observer) {
    ...
    com.jauntsdn.rsocket.generated_23183.ProtobufCodec.encode("FarmerClient", content, message);
    ...
    streams.requestStream(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("FarmerClient", trisocket.Meat.parser()), instrumentationListener));
  }
  ...
  public void veggies(trisocket.Order message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<trisocket.Veggie> observer) {
    ...
    streams.requestStream(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("FarmerClient", trisocket.Veggie.parser()), instrumentationListener));
  }
}
