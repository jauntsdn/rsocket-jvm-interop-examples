...
public final class RoundsmanClient implements Roundsman {
  ...
  public void chop(trisocket.Veggie message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<trisocket.Veggie> observer) {
    ...
    com.jauntsdn.rsocket.generated_23183.ProtobufCodec.encode("RoundsmanClient", content, message);
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("RoundsmanClient", trisocket.Veggie.parser()), instrumentationListener));
  }
  ...
  public void marinade(trisocket.Meat message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<trisocket.Meat> observer) {
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("RoundsmanClient", trisocket.Meat.parser()), instrumentationListener));
  }
}
