...
public final class RoundsmanClient implements Roundsman {
  ...
  public void chop(trisocket.Veggie message, io.netty.buffer.ByteBuf metadata, io.grpc.stub.StreamObserver<trisocket.Veggie> observer) {
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, decode(trisocket.Veggie.parser()), instrumentationListener));
  }

  @Override
  @com.jauntsdn.rsocket.Rpc.GeneratedMethod(returnType = trisocket.Meat.class)
  public void marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata, io.grpc.stub.StreamObserver<trisocket.Meat> observer) {
    int externalMetadataSize = streams.attributes().intAttr(com.jauntsdn.rsocket.Attributes.EXTERNAL_METADATA_SIZE);
    int dataSize = message.getSerializedSize();
    int localHeader = com.jauntsdn.rsocket.MessageMetadata.header(metadata);
    boolean isDefaultService = com.jauntsdn.rsocket.MessageMetadata.defaultService(localHeader);
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, decode(trisocket.Meat.parser()), instrumentationListener));
  }
