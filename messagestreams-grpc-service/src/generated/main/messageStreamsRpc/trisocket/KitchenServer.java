...
public final class KitchenServer implements com.jauntsdn.rsocket.RpcService {
  ...
  private KitchenServer(Kitchen service, com.jauntsdn.rsocket.RpcInstrumentation instrumentation, io.netty.buffer.ByteBufAllocator allocator, com.jauntsdn.rsocket.Rpc.Codec rpcCodec) {
    this.messageEncoder = com.jauntsdn.rsocket.generated_23183.ProtobufCodec.encode("KitchenServer", allocator, rpcCodec);
    ...
    try {
      ...
      switch (method) {
        case Kitchen.METHOD_SERVE: {
          ...
          com.jauntsdn.rsocket.Headers serveHeaders = com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decodeHeaders(metadata);
          ...
          io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> request = com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("KitchenServer", trisocket.Order.parser(), serve, observer);
