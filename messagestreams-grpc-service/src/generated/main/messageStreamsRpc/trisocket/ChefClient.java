...
public final class ChefClient implements Chef {
  ...
  public void roast(trisocket.Pan message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<trisocket.Dish> observer) {
    ...
    com.jauntsdn.rsocket.generated_23183.ProtobufCodec.encode("ChefClient", content, message);
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decode("ChefClient", trisocket.Dish.parser()), instrumentationListener));
  }
}
