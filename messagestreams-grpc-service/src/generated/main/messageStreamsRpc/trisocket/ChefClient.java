...
public final class ChefClient implements Chef {
  ...
  public void roast(trisocket.Pan message, io.netty.buffer.ByteBuf metadata, io.grpc.stub.StreamObserver<trisocket.Dish> observer) {
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, decode(trisocket.Dish.parser()), instrumentationListener));
  }
