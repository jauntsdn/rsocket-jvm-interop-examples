...
public final class ChefServer implements com.jauntsdn.rsocket.RpcService {
  ...
  private ChefServer(Chef service, com.jauntsdn.rsocket.RpcInstrumentation instrumentation, io.netty.buffer.ByteBufAllocator allocator, com.jauntsdn.rsocket.Rpc.Codec rpcCodec) {
    this.messageEncoder = com.jauntsdn.rsocket.generated_23183.ProtobufCodec.encode("ChefServer", allocator, rpcCodec);
  ...
  public io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> requestChannel(com.jauntsdn.rsocket.Message message, io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> observer) {
    try {
      ...
      observer.onError(new com.jauntsdn.rsocket.exceptions.RpcException("ChefServer: requestChannel unknown method: " + method));
      return com.jauntsdn.rsocket.MessageStreamsHandler.noopServerObserver();
    } catch (Throwable t) {
      observer.onError(t);
      return com.jauntsdn.rsocket.MessageStreamsHandler.noopServerObserver();
  ...
  private boolean requestResponseHandler(int flags, String method, io.netty.buffer.ByteBuf data, io.netty.buffer.ByteBuf metadata, io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> observer) throws java.io.IOException {
    switch (method) {
      case Chef.METHOD_ROAST: {
        ...
        com.jauntsdn.rsocket.Headers roastHeaders = com.jauntsdn.rsocket.generated_23183.ProtobufCodec.decodeHeaders(metadata);
        service.roast(trisocket.Pan.parseFrom(is), roastHeaders, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Server.encode(observer, messageEncoder, instrumentationListener));
        return true;
      }
      default: {
        return false;
