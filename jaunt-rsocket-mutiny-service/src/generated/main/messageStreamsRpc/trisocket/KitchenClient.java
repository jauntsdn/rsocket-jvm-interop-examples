...
public final class KitchenClient implements Kitchen {
  ...
  private final java.util.function.Function<io.smallrye.mutiny.Multi<trisocket.Dish>, io.smallrye.mutiny.Multi<trisocket.Dish>> serveInstrumentation;
  ...
  public io.smallrye.mutiny.Multi<trisocket.Dish> serve(org.reactivestreams.Publisher<trisocket.Order> messages, io.netty.buffer.ByteBuf metadata) {
    io.smallrye.mutiny.Multi<trisocket.Dish> serve = 
      io.smallrye.mutiny.Multi.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Multi<? extends com.jauntsdn.rsocket.Message>>() {

        @Override
        public io.smallrye.mutiny.Multi<com.jauntsdn.rsocket.Message> get() {
          return streams.requestChannel(io.smallrye.mutiny.Multi.createFrom().publisher(messages).map(
