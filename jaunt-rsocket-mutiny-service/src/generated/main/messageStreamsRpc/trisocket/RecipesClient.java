...
public final class RecipesClient implements Recipes {
  ...
  private final java.util.function.Function<io.smallrye.mutiny.Uni<trisocket.Recipe>, io.smallrye.mutiny.Uni<trisocket.Recipe>> marinadeInstrumentation;
  ...
  private RecipesClient(com.jauntsdn.rsocket.MessageStreams streams, java.util.Optional<com.jauntsdn.rsocket.RpcInstrumentation> instrumentation) {
    ...
    if (i == null) {
      ...
      this.marinadeInstrumentation = i.instrumentUni("client", Recipes.SERVICE, Recipes.METHOD_MARINADE);
    }
  ...
  public io.smallrye.mutiny.Uni<trisocket.Recipe> marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata) {
    io.smallrye.mutiny.Uni<trisocket.Recipe> marinade = io.smallrye.mutiny.Uni.createFrom().deferred(new java.util.function.Supplier<io.smallrye.mutiny.Uni<? extends com.jauntsdn.rsocket.Message>>() {
      @Override
