...
public final class RoundsmanClient implements Roundsman {
  ...
  public io.smallrye.mutiny.Uni<trisocket.Veggie> chop(trisocket.Veggie message, io.netty.buffer.ByteBuf metadata) {
  ...
  public io.smallrye.mutiny.Uni<trisocket.Meat> marinade(trisocket.Meat message, io.netty.buffer.ByteBuf metadata) {
