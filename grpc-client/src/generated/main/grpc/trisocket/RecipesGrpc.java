...
public final class RecipesGrpc {
   ...
   */
  public static RecipesBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<RecipesBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<RecipesBlockingV2Stub>() {
        @java.lang.Override
        public RecipesBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new RecipesBlockingV2Stub(channel, callOptions);
        }
      };
    return RecipesBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class RecipesBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<RecipesBlockingV2Stub> {
    private RecipesBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RecipesBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RecipesBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Recipes.
   */
